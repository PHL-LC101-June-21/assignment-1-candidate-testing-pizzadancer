...
function askForName() {
  ...
  candidateName = input.question("What is the candidate's (your) name? ");
  candidateName = capitalizeString(candidateName);
  // console.log("Name: " + candidateName);
}

function askQuestion() {
  // TODO 1.2b: Ask candidate the question and assign the response as candidateAnswer //
  // candidateAnswer = capitalizeString(input.question(question));
